...
SECRET_KEY = 'django-insecure-vtwz8u-f2l3yke+j8bb&i!rslm9t_h)ig4css&7)+t1n)t-jll'
...
VENU_PATH = os.path.dirname(BASE_DIR)
STATIC_ROOT = os.path.join(BASE_DIR, 'static/')

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(VENU_PATH, 'media_root')
